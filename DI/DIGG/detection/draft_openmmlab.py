...
def img_detection(choice):
    if(choice == "faster"):
        ...
        img = 'demo.jpg' #<class 'str'>
        #print("img:")
        #print(type(img)) #<class 'str'>
        ...
        # cv2.imshow('image_result_666', img)
        # cv2.waitKey(0)
        cv2.imwrite('result1_666.jpg', img)
        print("Result Saved.")
